...
export function regionAt(p){const {east,north}=toMetres(p.x,p.y);if(east< -9000)return 'Western frontier';if(east< -7800)return 'Beyond the rim / Falbreen';if(east< -6200)return 'Western crater rim';if(east< -5500&&north>1850&&north<2400)return 'Bright Angel';if(east< -4900&&north>1500&&north<2400)return 'Neretva Vallis';if(east< -2700)return north>900?'Upper fan / margin':'Southern delta plain';if(east< -1850&&north>1050&&north<1500)return 'Echo Creek';if(east< -850&&north>620)return 'Belva';if(north>504||east< -660&&north> -650)return 'Upper delta';if(east> -250&&east<350&&north> -250&&north<350)return 'Jenkins Gap';if(east>1400&&north< -1250)return 'Séítah';if(east>1500)return 'Landing plain';if(north> -120)return 'Western delta';if(east<0&&north> -650)return 'Delta front';if(east>600||north< -700)return 'Crater floor';return 'Three Forks';}
