...
export const discoveries=[
 ...
 {capturedAt:'2022-04-11',imageAlt:'NASA panorama of the Jezero delta front',imageCredit:'NASA/JPL-Caltech/ASU/MSSS',id:'rock',...toGame(-410,-420),name:'A broken edge',copy:'Erosion exposes the older layers inside the delta.',fact:'The delta’s present cliffs are an eroded remnant. Reading their exposed layers helps scientists reconstruct a landscape that no longer exists.',detail:'The April 2022 approach panorama shows the broken delta front, sand at its base and distant crater rim. No rock composition is inferred from color here.',source:'https://science.nasa.gov/photojournal/jezero-craters-delta-is-getting-closer/',image:'./assets/delta-panorama.jpg'},
 {capturedAt:'2022-04-11',imageAlt:'NASA panorama of the Jezero delta front and sandy foreground',imageCredit:'NASA/JPL-Caltech/ASU/MSSS',id:'sand',...toGame(180,-660),name:'Mars is still moving',copy:'Wind reshapes loose sand long after the river has gone.',fact:'The ancient delta and today’s wind-shaped sand tell stories from different times. A landscape can preserve the distant past while still changing.',detail:'Observe the sandy ground beneath the cliffs. The ripple appearance and loose rocks in this game are artistic interpretations; the broad terrain comes from orbital elevation measurements.',source:'https://science.nasa.gov/photojournal/jezero-craters-delta-is-getting-closer/',image:'./assets/delta-panorama.jpg'},
];
