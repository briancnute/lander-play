...
const RACE_VERSION='neretva-rally-v8';
...
try{
 ...
 $('#welcome p').textContent=`From touchdown to the western frontier. Follow the wide course and its chevrons. Visit every checkpoint; score your time on the path. Photos and activities are optional. Expedition kit equipped.`;
