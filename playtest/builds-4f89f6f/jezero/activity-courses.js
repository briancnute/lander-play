...
export function landingCircuit(){
 let points=[[-1250,480],[-1600,700],[-2050,780],[-2350,1120],[-2570,1510],[-2900,1780],[-3320,1690],[-3600,1900],[-3880,2070],[-4160,1960],[-4440,2110],[-4750,2040],[-4960,1800],[-5350,1900],[-5680,2080]].map(p=>toGame(...p));
