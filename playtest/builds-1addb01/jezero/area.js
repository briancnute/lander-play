...
export const discoveries=[
 {imageAlt:'NASA view near Hawksbill Gap, looking south across rocky delta terrain',imageCredit:'NASA/JPL-Caltech · Sol 428',id:'delta',...toGame(260,-250),name:'Layers of a lake',copy:'Sediment settled here when a river entered an ancient lake.',fact:'A delta forms where flowing water slows and drops the sediment it carries. Jezero’s layered rocks preserve parts of that ancient story.',detail:'Perseverance’s 2022 delta-front campaign examined rocks from the base upward to compare changing environments. This stop is an ASTRA observation point, not a named historical sampling target.',source:'https://science.nasa.gov/blog/next-stop-hawksbill-gap/',image:'../jezero-plan/assets/delta.jpg'},
