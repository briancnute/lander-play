...
export async function loadArea(){
 ...
 const area={...scenery,quietDiscoveries:true,mesh,ground:mesh.height,scenery:vertices,samples:discoveries,pickups,rocks:filtered,mesa:[],parts:[],keepExploring:true,bounds:{minX:3504,width:9744,minY:4128,maxY:9600},course,start,jump,info:mesh.info};
