...
export const landmarks=[{id:'kodiak',name:'Kodiak',...toGame(196,-1260),rise:12,
 ...
 detail:'The 2021 view appeared on the 5 November 2021 cover of Science. Its distant background is Jezero’s crater rim; the nearby cliffs north of Three Forks belong to the delta. Perseverance photographed this roughly 250-metre-wide butte from a distance. The image shows its layered cliffs in enhanced color. Kodiak is beyond this playtest’s driving boundary. This overlook preserves the documented sol-415 camera bearing while shortening the empty travel distance for the compact world; the iconic 2021 photograph came from a different, much more distant position.',
 capturedAt:'2021-04-18',iconic:true,imageDescription:'The iconic enhanced-color view of Kodiak, featured on the 5 November 2021 cover of Science. The exposed layers preserve evidence of an ancient lake and delta.',image:'./assets/kodiak.jpg',imageAlt:'Enhanced-color Perseverance photograph of Kodiak’s layered, flat-topped butte',
 ...
 views:[{label:'2022 · Another view',capturedAt:'2022-04-20',imageDescription:'A later, closer natural-color mosaic. Black margins are areas outside the combined camera coverage.',image:'./assets/kodiak-sol415.jpg',imageAlt:'Mastcam-Z panorama of Kodiak on sol 415, showing its cliff face and sloping shoulder',imageCredit:'NASA/JPL-Caltech/ASU/MSSS · 20 April 2022 · Natural color mosaic; black margins are gaps in coverage',source:'https://mastcamz.asu.edu/galleries/sol-0415-kodiak-long-baseline-stereo-part1-01-mastcam-z-mosaic/'}]}];
