...
export const discoveries=[
 {id:'delta',...toGame(260,-250),name:'Layers of a lake',copy:'Sediment settled here when a river entered an ancient lake.',fact:'A delta forms where flowing water slows and drops the sediment it carries. Jezero’s layered rocks preserve parts of that ancient story.',detail:'Perseverance’s 2022 delta-front campaign examined rocks from the base upward to compare changing environments. This stop is an ASTRA observation point, not a named historical sampling target.',source:'https://science.nasa.gov/blog/sampling-strategy-for-the-delta-front-campaign/',image:'../jezero-plan/assets/delta.jpg'},
 {id:'rock',...toGame(-410,-420),name:'A broken edge',copy:'Erosion exposes the older layers inside the delta.',fact:'The delta’s present cliffs are an eroded remnant. Reading their exposed layers helps scientists reconstruct a landscape that no longer exists.',detail:'The April 2022 approach panorama shows the broken delta front, sand at its base and distant crater rim. No rock composition is inferred from color here.',source:'https://science.nasa.gov/photojournal/jezero-craters-delta-is-getting-closer/',image:'../jezero-plan/assets/panorama.jpg'},
 {id:'sand',...toGame(180,-660),name:'Mars is still moving',copy:'Wind reshapes loose sand long after the river has gone.',fact:'The ancient delta and today’s wind-shaped sand tell stories from different times. A landscape can preserve the distant past while still changing.',detail:'Observe the sandy ground beneath the cliffs. The ripple appearance and loose rocks in this game are artistic interpretations; the broad terrain comes from orbital elevation measurements.',source:'https://science.nasa.gov/photojournal/jezero-craters-delta-is-getting-closer/',image:'../jezero-plan/assets/panorama.jpg'},
];
export async function loadArea(){
 ...
 const area={mesh,ground:mesh.height,scenery:vertices,samples:discoveries,pickups,rocks:filtered,mesa:[],parts:[],keepExploring:true,bounds:{minX:3504,width:9744,minY:4128,maxY:9600},course,start,jump,info:mesh.info};
