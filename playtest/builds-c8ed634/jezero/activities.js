...
export function createActivities(api,journey,record,stored={}){
 ...
 $('#journey-start').onclick=()=>confirm('Start a new expedition?',`Follow the wide course and visit every checkpoint in order. Your score is the percentage of moving time spent on the path. Restore the memory partition at every checkpoint and complete four roadside systems missions. Photographs and Ingenuity are optional. The 5× Perseverance clone is equipped for this expedition. Begin at Octavia E. Butler Landing; only this expedition resets, not discoveries, photographs or activity records.`,start,'Start expedition');
