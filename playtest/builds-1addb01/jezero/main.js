...
function showDiscovery(i,caller=null){if(caller==='#notes-dialog')notesReturn=backTo;const p=discoveries[i];if(!p||!progress.collected.includes(i))return;
 ...
 $('#discovery-credit').textContent=p.imageCredit+' · Regional reference; not a matched view from this stop.';
